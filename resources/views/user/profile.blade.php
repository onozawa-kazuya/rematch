                                ...
                                <div class="form-group row @if(!empty($errors->first('area'))) has-error @endif">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control form-control-sm" name="area2">
                                            <option value="">選択してください</option>
                                            @foreach(config('prefs') as $num => $pref)
                                                @if( isset(explode(',', $userlist->area)[1]) ? explode(',', $userlist->area)[1] : '' == $pref )
                                                <option selected value="{{ $num }}">{{ $pref }}</option>
                                                @else
                                                <option value="{{ $num }}">{{ $pref }}</option>
                                                @endif
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control form-control-sm" name="area3">
                                            <option value="">選択してください</option>
                                            @foreach(config('prefs') as $num => $pref)
                                                @if( isset(explode(',', $userlist->area)[2]) ? explode(',', $userlist->area)[2] : '' == $pref )
                                                <option selected value="{{ $num }}">{{ $pref }}</option>
                                                @else
                                                <option value="{{ $num }}">{{ $pref }}</option>
                                                @endif
                                ...
                                <div class="form-group row @if(!empty($errors->first('building'))) has-error @endif">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control form-control-sm" name="building2">
                                            <option value="">選択してください</option>
                                            <option {{ isset(explode(',', $userlist->building)[1]) ? explode(',', $userlist->building)[1] : '' == 'マンション' ? 'selected' : '' }}>マンション</option>
                                            <option {{ isset(explode(',', $userlist->building)[1]) ? explode(',', $userlist->building)[1] : '' == 'アパート' ? 'selected' : '' }}>アパート</option>
                                            <option {{ isset(explode(',', $userlist->building)[1]) ? explode(',', $userlist->building)[1] : '' == 'ビル' ? 'selected' : '' }}>ビル</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control form-control-sm" name="building3">
                                            <option value="">選択してください</option>
                                            <option {{ isset(explode(',', $userlist->building)[2]) ? explode(',', $userlist->building)[2] : '' == 'マンション' ? 'selected' : '' }}>マンション</option>
                                            <option {{ isset(explode(',', $userlist->building)[2]) ? explode(',', $userlist->building)[2] : '' == 'アパート' ? 'selected' : '' }}>アパート</option>
                                            <option {{ isset(explode(',', $userlist->building)[2]) ? explode(',', $userlist->building)[2] : '' == 'ビル' ? 'selected' : '' }}>ビル</option>
                                        </select>
                                    </div>
                                </div>
